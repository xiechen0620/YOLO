...
def predict_transform(prediction, inp_dim: int, anchors, num_classes):
    ...
    """this part should double check with paper"""
    ...
    new_prediction[:, :, :2].assign(new_prediction[:, :, :2] + x_y_offset_tensor)
